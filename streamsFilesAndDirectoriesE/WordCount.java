...
public class WordCount {
    public static void main(String[] args) throws IOException {
        ...
        String pathWords = "javaAdvanced/streamsFilesAndDirectoriesE/words.txt";
        ...
        String pathText = "javaAdvanced/streamsFilesAndDirectoriesE/text.txt";
        ...
        PrintWriter writer = new PrintWriter("javaAdvanced/streamsFilesAndDirectoriesE/result.txt");
